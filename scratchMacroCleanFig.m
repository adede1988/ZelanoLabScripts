...
curDat = load("R:\Neurology\Zelano_Lab\Lab_Common\Dupi\250818_Dupi_NMH_JH_1\raw\raw_breathingTasks\raw_breathingTasks.mat");
...
outDat.fs = 2000; 
outDat.figs = 'R:\Neurology\Zelano_Lab\Lab_Common\Adam\Dupi_processing\250818_Dupi_NMH_JH_1';
outDat.sessID =  '250818_Dupi_NMH_JH_1';
P = struct; 
P.macroRemove = [];
P.spikeClean = false; 
P.spikeWin = 44; 
