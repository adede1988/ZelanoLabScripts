function cue_plot_ztfr(map, timesMs, freqs, clim, resp, respT, dispWin, ttl, outPng)
% CUE_PLOT_ZTFR  Spectrogram (log-freq, raw Hz labels, z heat) with the mean
%   respiration trace overlaid on a right-hand axis.
