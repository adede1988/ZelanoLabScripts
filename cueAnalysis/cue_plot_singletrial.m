function cue_plot_singletrial(NT, sessID, bestMac, sep, outPng)
% CUE_PLOT_SINGLETRIAL  Stacked single-trial raw plot; NOISY trials drawn red.
%   NT = output of cue_noise_trials. Traces offset `sep` uV apart; y-ticks are
%   original trial numbers; trialStart at the blue line.
