...
3. Make a plot showing all single trial epochs on top of each other separated vertically by 50 uV, save to the per subject figs folder under the name "singleTrialRawMac.png"


**Outputs:** per-subject png
